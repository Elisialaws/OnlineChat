...
/**
 * @brief LoginDialog::slot_tcp_con_finish
 * @param bsuccess
 * 收到了tcpMsg的连接成功信号，发送登录请求
 */
...
/**
 * @brief LoginDialog::initHttpHandlers
 * 类似registerDialog
 */
void LoginDialog::initHttpHandlers()
{
    //shared_from_this需要构造完成，但是initHandlers在构造函数，所以用this捕获
    _handlers.insert(ReqId::ID_LOGIN_USER,[this](QJsonObject jsonObj){
        ...
        //发送信号通知tcpMgr发送长链接
        ServerInfo si;//包含port,host,token
