...
{
        m_pTextEdit = new QTextEdit();//inherit QFrame->QWidget
        m_pTextEdit->setReadOnly(true);
        m_pTextEdit->setVerticalScrollBarPolicy(Qt::ScrollBarAlwaysOff);//关闭滚动条
...
/**
 * @brief TextBubble::eventFilter
 * @param o
 * @param e
 * @return
 * 在拖拽窗口时实现文本框自动调整高度宽度，调用paint事件
 */
bool TextBubble::eventFilter(QObject *o, QEvent *e)
{
    ...
    return BubbleFrame::eventFilter(o,e);//返回基类事件过滤器
}
